  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEO 
        ...
        description="Classpace privacy policy. Learn how we collect, use, and protect your personal information and educational data. Your privacy is fundamental to our service."
        canonical="/privacy"
      />
